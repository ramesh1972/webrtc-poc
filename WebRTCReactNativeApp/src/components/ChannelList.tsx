...
interface Props {
  ...
  channelList: Channel[];
  headerText?: string;
  onChannelChange: (channel: any) => void; // Assuming there's an event to handle channel change
}
  ...
  render() {
    ...
    return (
      <View style={styles.channelListContainer}>
        ...
        <TouchableOpacity style={styles.hamburgerButton} onPress={this.toggleChannelsPanel}>
